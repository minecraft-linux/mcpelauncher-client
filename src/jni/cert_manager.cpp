...
std::shared_ptr<CertificateFactory> CertificateFactory::getInstance(
    std::shared_ptr<FakeJni::JString> s) {
    return std::make_shared<CertificateFactory>();
}

std::shared_ptr<Certificate> CertificateFactory::generateCertificate(
    std::shared_ptr<InputStream> s) {
    return std::make_shared<X509Certificate>();
}

std::shared_ptr<TrustManagerFactory> TrustManagerFactory::getInstance(
    std::shared_ptr<FakeJni::JString> s) {
