...
class HttpClientRequest : public FakeJni::JObject {
    ...
    static FakeJni::JBoolean isNetworkAvailable(
    ...
    void setHttpMethodAndBody2(std::shared_ptr<FakeJni::JString>,
                               FakeJni::JLong,
...
class HttpClientResponse : public FakeJni::JObject {
    ...
    std::shared_ptr<FakeJni::JString> getHeaderValueAtIndex(
        FakeJni::JInt index);
